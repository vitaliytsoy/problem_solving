...
class Solution:
    ...
    def candy(self, ratings: List[int]) -> int:
        ...
        while curr < len(ratings):
            ...
            if sign == 1:
                for i in range(start, end + 1):
                    if start == i and (candies[start] > 1 or ratings[start - 1] == ratings[start]):
                        candies[i + 1] = 1
                    else:
...
print(s.candy([405,927,916,158,441,804,804,818,816,624,986,767,998]))

# 1 3 2 1 2 3 1 2 1 2 3 1 2  
